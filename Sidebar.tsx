export default function Sidebar() {
  return (
    <div className="w-64 bg-slate-900 h-screen flex flex-col text-slate-300 font-medium border-r border-slate-800">
      ...
      <div className="h-16 flex items-center px-6 border-b border-slate-800 mb-4">
        ...
        <span className="text-white text-lg font-bold tracking-wide">SOLIDCORE</span>
      </div>

      {/* Navigation Links */}
      <nav className="flex-1 px-4 space-y-2">
        {/* Active Link */}
        <a href="#" className="flex items-center px-3 py-2.5 bg-blue-600 text-white rounded-lg transition-colors">
          <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
          Dispatch Board
        </a>

        {/* Inactive Links */}
        <a href="#" className="flex items-center px-3 py-2.5 rounded-lg hover:bg-slate-800 hover:text-white transition-colors">
