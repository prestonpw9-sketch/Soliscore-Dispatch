...
const SettingsView: React.FC = () => {
  ...
  const [companyName, setCompanyName] = useState('ITDG Construction');
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Manage your business profile, app preferences, and database connections.
          </p>
        </div>
        <button
          type="submit"
          className="flex items-center gap-2 bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors shadow-sm shrink-0"
        >
        ...
        <div className="w-full md:w-64 shrink-0">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm flex flex-row md:flex-col">
            <button
              ...
              className={`flex-1 md:flex-none flex items-center gap-3 px-4 py-3 text-sm font-medium transition-colors border-b-2 md:border-b-0 md:border-l-2 ${
                activeTab === 'profile'
              ...
              <div className="p-6 animate-in fade-in slide-in-from-bottom-2 duration-200">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label
                        htmlFor="qualifyingParty"
                        className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1"
                      >
                        Plumbing Qualifying Party
                      </label>
                      <input
                        id="qualifyingParty"
                        type="text"
                        value={qualifyingParty}
                        onChange={e => setQualifyingParty(e.target.value)}
                        className="w-full px-3 py-2 border border-slate-300 dark:border-slate-700 rounded-lg text-sm bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-teal-500 outline-none transition-shadow"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 border border-slate-200 dark:border-slate-700 rounded-lg">
                    <div>
                      ...
                      <div className="text-xs text-slate-500">
                        Push notifications when high-priority calls come in.
                      </div>
                    </div>
              ...
              <div className="p-6 animate-in fade-in slide-in-from-bottom-2 duration-200">
                <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-xs text-purple-700 dark:text-purple-400">
                    Enter your project credentials to sync jobs, commercial phases, and dispatch records to the cloud.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    <label
                      htmlFor="supabaseUrl"
                      className="text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1 flex items-center gap-1"
                    >
                      Project URL
                    </label>
                    <input
