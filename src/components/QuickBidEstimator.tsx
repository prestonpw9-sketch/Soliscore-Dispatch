...
const CATALOG: Record<CatalogTab, CatalogItem[]> = {
  dwv: [
    ...
    { id: 'd-3-1', size: '3"',    item: 'PVC DWV Pipe (solid)',              price: 1.855  },
    { id: 'd-4-1', size: '4"',    item: 'PVC DWV Pipe (solid)',              price: 2.644  },
    { id: 'd-2-1', size: '2"',    item: 'PVC DWV Pipe (solid)',              price: 0.881  },
    { id: 'd-15-1',size: '1-1/2"',item: 'PVC DWV Pipe (solid)',              price: 0.666  },
    ...
    { id: 'ci11',  size: '4"',    item: 'NO HUB BANDS (Standard)',            price: 10.131 },
    { id: 'ci11b', size: '3"',    item: 'NO HUB BANDS (Standard)',            price: 9.159  },
    { id: 'ci12',  size: '2"',    item: 'NO HUB BANDS (Standard)',            price: 7.166  },
    { id: 'ci12b', size: '1-1/2"',item: 'NO HUB BANDS (Standard)',            price: 6.747  },
    { id: 'ci13',  size: '4"',    item: 'NH CI Pipe',                         price: 18.402 },
    { id: 'ci14',  size: '3"',    item: 'NH CI Pipe',                         price: 14.179 },
    { id: 'ci15',  size: '2"',    item: 'NH CI Pipe',                         price: 10.254 },
    { id: 'ci16',  size: '1-1/2"',item: 'NH CI Pipe',                         price: 10.231 },
  ],
  // Pipe prices from Reece quote S123995913 (7/14/2026), $/ft.
  copper: [
    { id: 'c1',    size: '3"',     item: 'L HARD COPPER',                    price: 59.40  },
    { id: 'c2',    size: '2-1/2"', item: 'L HARD COPPER',                    price: 40.104 },
    { id: 'c3',    size: '2"',     item: 'L HARD COPPER',                    price: 25.959 },
    { id: 'c3b',   size: '1-1/2"', item: 'L HARD COPPER',                    price: 16.590 },
    { id: 'c3c',   size: '1-1/4"', item: 'L HARD COPPER',                    price: 13.071 },
    { id: 'c3d',   size: '1"',     item: 'L HARD COPPER',                    price: 7.078  },
    { id: 'c3e',   size: '3/4"',   item: 'L HARD COPPER',                    price: 4.815  },
    { id: 'c3f',   size: '1/2"',   item: 'L HARD COPPER',                    price: 2.943  },
    ...
    { id: 'cpvc1', size: '2"',     item: 'CPVC Pipe',                        price: 4.741  },
    { id: 'cpvc2', size: '1-1/2"', item: 'CPVC Pipe',                        price: 2.845  },
    { id: 'cpvc3', size: '1-1/4"', item: 'CPVC Pipe',                        price: 1.647  },
    { id: 'cpvc4', size: '1"',     item: 'CPVC Pipe',                        price: 1.225  },
    { id: 'cpvc5', size: '3/4"',   item: 'CPVC Pipe',                        price: 0.619  },
    { id: 'cpvc6', size: '1/2"',   item: 'CPVC Pipe',                        price: 0.408  },
    { id: 'cpvc7', size: 'Lot',    item: 'CPVC Fittings (Est. 50%)',          price: 0.00   },
    { id: 'pex1',  size: '2"',     item: 'PEX Pipe',                         price: 8.257  },
    { id: 'pex2',  size: '1-1/2"', item: 'PEX Pipe',                         price: 4.286  },
    { id: 'pex3',  size: '1-1/4"', item: 'PEX Pipe',                         price: 2.81   },
    { id: 'pex4',  size: '1"',     item: 'PEX Pipe',                         price: 1.412  },
    { id: 'pex5',  size: '3/4"',   item: 'PEX Pipe',                         price: 0.776  },
    { id: 'pex6',  size: '1/2"',   item: 'PEX Pipe',                         price: 0.449  },
    { id: 'pex7',  size: 'Lot',    item: 'PEX Fittings (Est. 60%)',           price: 0.00   },
    { id: 'bi1',   size: '2"',     item: 'BLK Pipe (Gas)',                   price: 3.968  },
    { id: 'bi2',   size: '1-1/2"', item: 'BLK Pipe (Gas)',                   price: 2.953  },
    { id: 'bi3',   size: '1-1/4"', item: 'BLK Pipe (Gas)',                   price: 2.458  },
    { id: 'bi4',   size: '1"',     item: 'BLK Pipe (Gas)',                   price: 1.822  },
    { id: 'bi5',   size: '3/4"',   item: 'BLK Pipe (Gas)',                   price: 1.266  },
    { id: 'bi6',   size: '1/2"',   item: 'BLK Pipe (Gas)',                   price: 0.956  },
  ],
  fixtures: [
